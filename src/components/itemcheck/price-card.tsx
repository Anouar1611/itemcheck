    ...
    <Card className="shadow-lg">
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center space-x-2">
          ...
          <Badge variant={priceData.isFairPrice ? "default" : "destructive"}>
        ...
        {priceData.fairMarketValue && (
          <div>
            <h4 className="font-semibold text-md mb-1 flex items-center"><BadgeDollarSign className="w-5 h-5 mr-2 text-primary"/>Fair Market Value</h4>
        ...
        {priceData.priceReasoning && (
          <div>
            <h4 className="font-semibold text-md mb-1 flex items-center"><MessageCircleQuestion className="w-5 h-5 mr-2 text-accent"/>Reasoning</h4>
