    ...
    <Card className="shadow-lg bg-card border-border/50">
      <CardHeader>
        <div className="flex items-center space-x-3">
          ...
          <CardTitle className="text-2xl text-foreground">Price Fairness</CardTitle>
        </div>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center space-x-2">
          ...
          <Badge variant={isFair ? "default" : "destructive"} className={isFair ? "bg-primary/20 text-primary border border-primary/30" : "bg-destructive/20 text-destructive border border-destructive/30"}>
        ...
        {priceData.fairMarketValue && (
          <div>
            <h4 className="font-semibold text-md mb-1 flex items-center text-foreground"><BadgeDollarSign className="w-5 h-5 mr-2 text-primary"/>Fair Market Value</h4>
            <p className="text-xl font-bold text-foreground">{priceData.fairMarketValue}</p>
          </div>
        )}
        
        {priceData.priceReasoning && (
          <div>
            <h4 className="font-semibold text-md mb-1 flex items-center text-foreground"><MessageCircleQuestion className="w-5 h-5 mr-2 text-accent"/>Reasoning</h4>
            <p className="text-sm text-muted-foreground bg-input p-3 rounded-md border border-border/50">{priceData.priceReasoning}</p>
          </div>
        )}
